...
<body style="font-family: 微软雅黑">
	<div class="page-lock">
		...
		<form action="${pageContext.request.contextPath }/user/login.action" method="post" id="loginForm">
			<div class="page-body">
				...
				<div class="page-lock-info">
					...
					<c:choose>
						...
						<c:otherwise>
							<span style="padding-top: 5px"><font color="red">${message1}</font></span>
						</c:otherwise>
					</c:choose>
			...
			<div class="page-footer" style="color:black;">
   ...
   <![endif]-->
	...
	<div class="backstretch" style="left: 0px; top: 0px; overflow: hidden; margin: 0px; padding: 0px; z-index: -999999; position: fixed; width: 1060px; height: 570px;"><img style="position: absolute; margin: 0px; padding: 0px; border: medium none; max-width: none; z-index: -999999; width: 1060px; height: 636.621px; left: 0px; top: -33.3105px;" src="../js/metronic/img/bg/1.jpg"></div>
</body>
<!-- END BODY -->
</html>