...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${pageContext.request.contextPath }/user/updateUser.action" id="userForm" method="post">
    	 	<!-- 隐藏表单，flag表示添加标记 -->
		  ...
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			...
		    			<td class="font3 fftd">状态：<input type="text" name="status" id="status" size="20" value="${user.status }"/>
		    			<!-- <select name="status">
		   ...
		   <c:if test="${message!=null}">
				<span style="padding-top: 5px"><font color="red">${message}</font></span>
			</c:if>
		 </form>
	</td>
  </tr>
