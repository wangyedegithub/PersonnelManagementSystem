...
<table width="100%" height="90%" border="0" cellpadding="5" cellspacing="0" class="main_tabbor">
  <tr valign="top">
    <td>
    	 <form action="${pageContext.request.contextPath }/user/addUser.action" id="userForm" method="post">
    	 	<!-- 隐藏表单，flag表示添加标记 -->
		    ...
		    <tr><td class="font3 fftd">
		    	<table>
		    		<tr>
		    			...
		    			<td class="font3 fftd">
		    			状&nbsp;态：<input type="text" name="status" id="status" size="20" value="${user.status}"/>
		    			<!-- <select name="status">
