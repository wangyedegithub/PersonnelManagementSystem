	...
	<script type="text/javascript">
	    $(function(){
	 		   ...
	 		   if(checkedBoxs.length < 1){
	 			   ...
	 			   $.ligerDialog.confirm("确认要删除吗?","删除文档",function(r){
	 				   if(r){
	 					   // alert("删除："+ids.get());
	 					   // 发送请求
	 					   window.location = "${pageContext.request.contextPath }/document/removeDocument.action?ids=" + ids.get();
	 				   }
	 			   });
	 		   }
	 	   })
	    	...
	    	$("a[id^='down_']").click(function(){
	    		...
	    		/** 下载该文档 */
	    		window.location = "${pageContext.request.contextPath }/document/downLoad.action?id="+id;
	    	})
	  ...
	  <tr valign="top">
	    <td height="30">
		  <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
		    <tr>
			  <td class="fftd">
			  	<form name="documentform" method="post" id="documentform" action="${pageContext.request.contextPath }/document/selectDocument.action">
	  ...
	  <tr valign="top">
	    <td height="20">
		  <table width="100%" border="1" cellpadding="5" cellspacing="0" style="border:#c2c6cc 1px solid; border-collapse:collapse;">
			...
			<c:forEach items="${page.records}" var="document" varStatus="stat">
				<tr ondblclick="down(${document.id});"  class="main_trbg" align="center" id="data_${stat.index}">
					<td><input type="checkbox" id="box_${stat.index}" value="${document.id}"></td>
					 ...
					 <td align="center" width="40px;"><a href="${pageContext.request.contextPath }/document/updateDocument.action?flag=1&id=${document.id}">
