...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/js/tiny_mce/tiny_mce.js"></script>
<script type="text/javascript"
		...
		<tr valign="top">
			<td>
				...
				<form id="documentForm" name="documentForm"
					action="${pageContext.request.contextPath }/document/updateDocument.action"
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="10"
						class="main_tab">
						<tr>
							<td class="font3 fftd">文档标题：<input type="text" name="title"
								size="30" id="title" value="${document.title }" /></td>
						</tr>
						<tr>
							<td class="main_tdbor"></td>
						</tr>
						<tr>
							<td class="font3 fftd">文档描述：<br /> <textarea name="remark"
									cols="88" rows="11" id="content">${document.remark }</textarea>
							</td>
						</tr>
						<tr>
							<td class="main_tdbor"></td>
						...
						<tr>
							<td class="font3 fftd">文档：<br /> <input type="file"
								name="file" id="file" size="30" value="${document.file }" />
							</td>
						</tr>
						<tr>
							<td class="main_tdbor"></td>
