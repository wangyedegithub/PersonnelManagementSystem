					...
					<table width="100%" border="0" cellpadding="0" cellspacing="10"
								...
								<table>
									<tr>
										<td class="font3 fftd">姓名：<input type="text" name="name"
											id="name" size="20" value="${employee.name }" />
										</td>
									...
									<tr>
										<td class="font3 fftd">学历：<input name="education"
											id="education" size="20" value="${employee.education }" />
										</td>
										<td class="font3 fftd">邮&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;箱：<input
											name="email" id="email" size="20" value="${employee.email }" />
										</td>
									</tr>
									<tr>
										<td class="font3 fftd">手机：<input name="phone" id="phone"
											size="20" value="${employee.phone }" />
										</td>
										<td class="font3 fftd">电&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;话：<input
											name="tel" id="tel" size="20" value="${employee.tel }" />
										</td>
									</tr>
						...
						<tr>
							<td class="font3 fftd">政治面貌：<input name="party" id="party"
								size="40" value="${employee.party }" />&nbsp;&nbsp;
								QQ&nbsp;&nbsp;号码：<input name="qqNum" id="qqNum" size="20"
								value="${employee.qqNum }" /></td>
						</tr>
						<tr>
							<td class="main_tdbor"></td>
						</tr>
						...
						<tr>
							<td class="font3 fftd">出生日期：<input cssClass="Wdate"
								...
								size="20" value="${employee.race }" /></td>
						</tr>
						<tr>
							<td class="main_tdbor"></td>
						</tr>
						...
						<tr>
							<td class="font3 fftd">所学专业：<input name="speciality"
								...
								size="20" value="${employee.hobby }" /></td>
						</tr>
						<tr>
							<td class="main_tdbor"></td>
						</tr>
						...
						<tr>
							<td class="font3 fftd">备&nbsp;&nbsp;&nbsp;&nbsp;注：<input
								...
								&nbsp;&nbsp;所属部门： <select name="dept.id" style="width:100px;">
						...
						<tr>
							<td align="left" class="fftd"><input type="submit"
								value="修改">&nbsp;&nbsp;<input type="reset" value="取消 ">
							</td>
						</tr>
					</table>
				</form></td>
